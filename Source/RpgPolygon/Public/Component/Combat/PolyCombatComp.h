...
#include "PolyCombatComp.generated.h"
 ...
 */
UCLASS()
class RPGPOLYGON_API UPolyCombatComp : public UPawnCombatComp, public ICombatInterface
{
	GENERATED_BODY()

public:
	virtual void
	InitDependencies(UPawnWeaponComp* InPawnWeaponComp, UMotionWarpingComponent* InMotionWarpingComp) override;
...
protected:
	UPolyWeaponComp* GetOwningPolyWeaponComp() const { return OwningPolyWeaponComp.Get(); }

private:
	TWeakObjectPtr<UPolyWeaponComp> OwningPolyWeaponComp;
};
